    ...
    <div>
                    ...
                    <v-card :elevation="hover ? 12 : 2" class="pa-4" :class="{ 'card-hover': hover }">
                        ...
                        <v-list>
                            ...
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    Op basis van de besproken details wordt er een product ontwerp gemaakt. Gedurende dit proces is het belangrijk dat de klant tevreden is met het ontwerp en dat de software voldoet aan de gestelde eisen.
                                </v-list-item-content>
                            </v-list-item>
                            <v-list-item>
                                <v-list-item-icon>
                                ...
                                <v-list-item-content>
                                    Zodra het eindproduct klaar is zorgt VonkProgramming ervoor dat enige bugs eruit gefilterd worden tot dat de klant tevreden is met het eindresultaat.
                                </v-list-item-content>
                            </v-list-item>
                        </v-list>
                    </v-card>
        ...
        <v-row justify="center" class="pb-12">
            ...
            <v-col cols="12" sm="12" md="4" align="center">
                ...
                <p class="body-2">
                    Naast websites en webapps biedt VonkProgramming ook mogelijkheden binnen NodeJS en Ionic. 
                    Deze twee solutions kunnen gebruikt worden voor het bouwen van serversystemen en mobiele apps.
                </p>
            </v-col>
        </v-row>
